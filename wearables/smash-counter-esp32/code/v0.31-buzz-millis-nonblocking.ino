// Smash Counter ESP32 v0.31 — buzz() millis() Nonblocking
// Lishan, 14 June 2026
//
// What happened:
...
//
// Major fix:
// Previous buzz() used delay() — blocked Core 1 main loop.
// WiFi task on Core 0 couldn't get data from Core 1.
// Watchdog timer killed process after timeout (freeze crash).
//
// Solution:
// Replaced delay() with millis() timer-based approach.
...
//
// Implementation:
// handleBuzz() called every loop iteration (non-blocking).
// Tracks time elapsed since buzz started.
// Toggles GPIO15 based on pulse timing.
// Cleans up when buzz sequence completes.
//
// Testing results:
// Tested stable — motor responds correctly ✓
// No freeze during hard smashes ✓
// Multiple buzzes work without overlap ✓
// WiFi dashboard updates during buzz ✓
//
// Session context:
// Device had freeze crash at ~10 seconds.
// Root cause confirmed: buzz() blocking Core 1.
// Fix applied and tested.
// Ready for motor physical connection.
//
// Next steps:
// Wire haptic motor to GPIO15 (when Papa ready)
// Court test with real players
// 3D case finalization
