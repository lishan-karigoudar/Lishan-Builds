// Smash Counter ESP32 v0.22 — Battery Indicator
// Lishan, 4 June 2026
//
// New feature: Battery level indicator
// Shows battery icon at top right of round display.
// Green = above 50%, Orange = 20-50%, Red = below 20%.
// Also shows battery % on WiFi dashboard.
//
// Battery circuit on this board:
// GPIO1 = BAT_ADC
// Voltage divider: R13=200K, R14=100K
// Correct multiplier = 3.0 (not 2.0 — needs calibration)
//
// Known issue: Reading shows 0% because multiplier is wrong.
// Correct formula should be:
// float voltage = (raw / 4095.0) * 3.3 * 3.0;
// Battery calibration pending — Serial debug added in v0.23.
//
// Battery connected wirelessly — Papa connected without soldering.
// Board charges via USB while battery connected simultaneously.
// Built-in charging circuit: ETA6098.
...
int getBatteryPct() {
  ...
  float voltage = (raw / 4095.0) * 3.3 * 2; // NOTE: multiplier should be 3.0 — pending calibration
