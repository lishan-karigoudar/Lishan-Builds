// Smash Counter ESP32 v0.20 — Deep Sleep
// Lishan, 2 June 2026
//
// New feature: Deep Sleep mode
// Short press BOOT = reset counter
// Long press BOOT 3 seconds = deep sleep
// Press BOOT once to wake up
//
// Why deep sleep matters:
// Without sleep, battery drains even when not playing.
// Deep sleep uses almost zero power — microamps.
// Real smartwatches use this to last days on one charge.
//
// How it works:
// esp_sleep_enable_ext0_wakeup(GPIO_NUM_0, 0) — BOOT wakes it
// esp_deep_sleep_start() — enters deep sleep immediately
// Screen shows "Sleeping... Press BOOT to wake up"
// Backlight turns off
// Device enters ultra low power state
//
// Hardware update — 29 May 2026:
// All robu.in components arrived:
// BC547 transistors x6
// 1K resistors x10
// JST 1.25mm connectors x2
// Vibration motors 3V 4x8mm x2
//
// Battery connected without soldering!
// Papa found a way to connect without soldering.
// Device now runs wirelessly on battery. ✅
//
// Still crashing on hard smash — fixed in v0.21.
