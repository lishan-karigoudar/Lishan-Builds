// Smash Counter ESP32 v0.23 — Battery Serial Debug
// Lishan, 8 June 2026
//
// Purpose: Calibrate battery ADC reading.
// getBatteryPct() now prints raw ADC value and
// calculated voltage to Serial Monitor every read.
//
// How to calibrate:
// 1. Connect battery AND USB at the same time
// 2. Upload this sketch
// 3. Open Serial Monitor at 115200 baud
// 4. Press RST button
// 5. Read the BAT raw and voltage values
// 6. Adjust multiplier in getBatteryPct() accordingly
//
// Schematic confirmed:
// R13 = 200K, R14 = 100K
// Correct multiplier = (200K + 100K) / 100K = 3.0
// Current code uses 2.0 — that is why reading shows 0%
//
// Result of this session:
// Battery reading 0 on Serial Monitor — battery was on
// USB only without battery connected during test.
// Needs battery + USB simultaneously for calibration.
