// Smash Counter ESP32 v0.30 — WiFi IP Dynamic
// Lishan, 13 June 2026
//
// Change: WiFi IP address now displays correctly on dashboard.
// Event handler captures connection state — no hardcoded IP needed.
//
// WiFi event listener added:
// Registers on ARDUINO_EVENT_WIFI_STA_GOT_IP event.
// IP address stored in volatile String variable.
// WiFi dashboard shows live IP when connected.
//
// Eliminates hardcoded IP address approach.
// Now truly dynamic — changes if network restarts.
//
#include <Wire.h>
#include <math.h>
